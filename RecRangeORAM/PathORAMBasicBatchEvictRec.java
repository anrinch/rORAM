...
import server.PathORAMBasic;
import server.PathORAMBasic.Tree.Block;
import server.PathORAMRec;

public class PathORAMBasicBatchEvictRec extends PathORAMBasicForRec{
...
private int clientStoreCutoff = 1;
	...
	public PathORAMBasicBatchEvictRec (int cutoff, SecureRandom rng) { super(rng); clientStoreCutoff = cutoff; }
	public PathORAMBasicBatchEvictRec(int cutoff) { this(cutoff, new SecureRandom()); }
	...
	protected PathORAMBasicForRec.Tree.Block[] access(long reqId, BitSet[] posMap, PathORAMBasicForRec.OpType op, int a, BitSet data) 
	{
		Tree tr = serverTree;
